...
public class QuestionController {
    ...
    public BaseResponse<List<QuestionContentDTO>> aiGenerateQuestion(@RequestBody AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        int qusetionNumber = aiGenerateQuestionRequest.getQuestionNumber();
        int optionNumber = aiGenerateQuestionRequest.getOptionNumber();
        //获取应用信息
        App app = appServise.getById(appId);
        ThrowUtils.throwIf(app == null, ErrorCode.NOT_FOUND_ERROR);
        //封装 Prompt
        String userMassage = getGenerateQuestionUserMessage(app, qusetionNumber, optionNumber);
        // AI 生成
        String result = aiManager.doSyncRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMassage, null);
        // 截取需要的json信息
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest, HttpServletRequest request) {
        ...
        // AI 生成, SSE 流式返回
        Flowable<ModelData> modelDataFlowable = aiManager.doStreamRequest(GENERATE_QUESTION_SYSTEM_MESSAGE, userMassage, null);
        // 左括号计数器，除了默认外，当 回归为 0 时，表示左括号等于右括号，可以截取
        ...
        modelDataFlowable
                ...
                .doOnError((e) -> log.error("sse error"))
